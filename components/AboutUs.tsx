      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          {developers.map((dev, index) => (
            ...
            >
              {/* Card Container */}
              <div className="glass-panel h-full rounded-2xl p-6 flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-2 hover:bg-white/5 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/20">
                ...
                {/* Text Content */}
                <h3 className="text-xl font-bold text-white mb-1 group-hover:text-purple-300 transition-colors p-2">
                  {dev.name}
                </h3>
                <span className="text-xs font-medium px-3 py-1 bg-purple-500/10 rounded-full text-purple-200 mb-3 border border-purple-500/20 group-hover:bg-purple-500/30 transition-all">
                  {dev.role}
                </span>
                ...
                <div className="mt-auto pt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-2 group-hover:translate-y-0">
                  <span className="text-xs text-pink-400 flex items-center gap-1 font-medium">
                    Kunjungi Profil
