    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="text-center space-y-6 max-w-2xl glass-panel p-10 rounded-3xl">
        ...
        <button
          ...
          className="px-8 py-4 bg-white text-purple-900 rounded-full font-bold text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-xl hover:shadow-white/20"
        >
          Mulai Tes IQ
        </button>
      </div>
